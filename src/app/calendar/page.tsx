            ...
            {daysInMonth.map(day => {
              ...
              return (
                <div
                  ...
                  onClick={e => {
                    // Only open new event modal if the click is on the day cell itself, not on an event
                    ...
                    {dayEvents.map(event => (
                      <div
                        ...
                        onClick={e => {
                          ...
                          // Map event to expected shape for modal (handle snake_case and camelCase)
                          setViewEvent({
                            ...event,
                          ...
                          setTimeout(() => {
                            console.log('viewEvent after set:', viewEvent);
                          }, 100);
                        }}
                      >
